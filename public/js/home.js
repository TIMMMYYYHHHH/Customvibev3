...
const MAGNET_POSITIONS = [
  { top: '12%', left: '8%', rotate: '-7deg', hoverRotate: '-2deg', floatDur: '7s', floatDelay: '0s' },
  { top: '10%', left: '56%', rotate: '6deg', hoverRotate: '1deg', floatDur: '5.5s', floatDelay: '-2s' },
  { top: '54%', left: '30%', rotate: '-3deg', hoverRotate: '2deg', floatDur: '6.5s', floatDelay: '-1s' },
];
