...
function LegalPageLayout({ title, children }: LegalPageProps) {
  return (
    <div className="max-w-2xl mx-auto px-4 md:px-12 py-section-sm">
      <Link to="/" className="inline-flex items-center gap-1.5 text-xs font-bold text-brand-pink-text hover:underline mb-8">
        <ArrowLeft className="w-4 h-4" /> Back to home
      </Link>
      <div className="bg-white rounded-panel border border-brand-pink-soft shadow-soft p-8 sm:p-10 space-y-4">
...
export function PrivacyPage() {
  return (
    <LegalPageLayout title="Privacy Policy">
      ...
      <p className="text-zinc-400 text-label-xs uppercase tracking-wider font-bold">Placeholder policy. Replace with your finalized privacy policy before launch.</p>
    </LegalPageLayout>
  );
}
...
export function TermsPage() {
  return (
    <LegalPageLayout title="Terms of Craft">
      ...
      <p className="text-zinc-400 text-label-xs uppercase tracking-wider font-bold">Placeholder terms. Replace with your finalized terms of service before launch.</p>
    </LegalPageLayout>
  );
}
...
export function ContactPage() {
  return (
    <LegalPageLayout title="Get In Touch">
      ...
      <p className="text-zinc-400 text-label-xs uppercase tracking-wider font-bold">Placeholder contact details. Replace with your real phone number and address.</p>
    </LegalPageLayout>
  );
}
